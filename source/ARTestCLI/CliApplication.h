...
namespace artest::cli
{
    ...
    private:
        ...
        [[nodiscard]] int RunPlan(const std::string& command, const std::string& scriptPath, std::unordered_set<std::size_t> breakpoints, const std::string& extensionRoot = {}, bool compatibilityJson = false);
