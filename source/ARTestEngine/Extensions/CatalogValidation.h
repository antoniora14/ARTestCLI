    ...
    [[nodiscard]] inline std::string StringValue(const nlohmann::json &object, const char *name)
{
    ...
    [[nodiscard]] inline std::uint32_t UnsignedValue(const nlohmann::json &object, const char *name, std::uint32_t fallback)
{
    const auto found = object.find(name);
    ...
    [[nodiscard]] inline bool HasOnlyProperties(const nlohmann::json &object, std::initializer_list<const char *> allowed)
{
    ...
    [[nodiscard]] inline bool IsSemanticVersion(const std::string &value)
{
    ...
    [[nodiscard]] inline bool IsContained(const std::filesystem::path &root, const std::filesystem::path &candidate)
{
    ...
    [[nodiscard]] inline bool IsHexSha256(const std::string &value)
{
    ...
    inline void AddPackageDiagnostic(artest::extensions::CatalogPackage &package, std::string code, std::string message, std::string location = {})
{
    ...
    void ValidateComponent(const nlohmann::json &component, CatalogPackage &package, std::set<std::string> &packageTypes);
