...
Status: approved planning decision, 2026-09-13. PY-DX-01 Stage 1 is accepted;
Stages 2-5 remain pending. No Stage 2 implementation is started by this closure.
...
| 3 | PY-DX-01: Python Developer Experience: create, prepare and run | Stage 1 accepted; Stage 2 is next within the approved plan; overall iteration not yet accepted |
